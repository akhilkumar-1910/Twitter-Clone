...
# source: proto/twitter_clone.proto
...
Tweet = _reflection.GeneratedProtocolMessageType('Tweet', (_message.Message,), {
  'DESCRIPTOR' : _TWEET,
  '__module__' : 'proto.twitter_clone_pb2'
